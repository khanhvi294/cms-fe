...
const Profile = () => {
  ...
  return (
    <div className="flex gap-9">
      <Box className="container flex h-[300px] w-[300px]   flex-col justify-around items-center rounded border bg-white p-8 shadow-xl">
        <Typography
      ...
      <div className="flex flex-col justify-around rounded border bg-white p-8 shadow-xl w-[900px] gap-6">
