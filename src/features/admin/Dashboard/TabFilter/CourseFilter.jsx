...
import { filterCourseByDate } from '../../../../services/dashboardService';
...
const CourseFilter = () => {
    ...
    const columns = [
        ...
        {
            field: "trainingTime", // Thêm cột mới cho tên của courseClass
            headerName: "trainingTime ",
            width: 300,
            valueGetter: (params) => params.row.trainingTime,
          },
        {
    ...
    const {data} = useQuery({
        ...
        queryFn: () => filterCourseByDate({from:fromDate, to:toDate})
    })
