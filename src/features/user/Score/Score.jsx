...
const dataScore = [
  {
    id: 1,
    competitionName: "Giải thuât",
    class: "Lập trình ứng dụng 20231",
  },
];
...
const Scores = () => {
  ...
  const columns = [
    ...
    { field: "name", headerName: "competitionName", width: 250 },
    {
      field: "course", // Thêm cột mới cho tên của courseClass
      headerName: "Course ",
      width: 200,
      valueGetter: (params) => params.row.courseClass.name,
    },
    { field: "class", headerName: "class", width: 200 },
    { field: "timeStart", headerName: "timestart", width: 130 },
    { field: "timeEnd", headerName: "timeend", width: 130 },
    { field: "totalScore", headerName: "totalScore", width: 150 },
    {
      field: "actions",
      type: "actions",
      headerName: "Actions",
      ...
      getActions: (params) => {
        ...
        if (new Date(params.row.timeStart) > new Date()) {
          return [
            <GridActionsCellItem
              icon={
                <svg
  ...
  return (
    <>
      <div className="flex gap-2 justify-between items-center">
        <span className="text-2xl font-semibold">Scores</span>
      </div>
