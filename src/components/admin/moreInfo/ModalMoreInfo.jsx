...
const ModalMoreInfo = ({ open, setOpen, user }) => {
  return (
    <div>
      ...
      >
        <Box className="bg-white w-[900px] min-h-[200px] rounded-2xl p-4 flex flex-col gap-6">
          <Typography
          ...
          >
            {user?.accountEmployee ? "Info Employee" : "Info Student"}
          </Typography>
          <div className="flex flex-col justify-around rounded-2xl  bg-white p-8  gap-6">
            ...
            <div className="flex gap-5">
              ...
              <TextField
                ...
                className="w-full bg-gray-100"
                defaultValue={
                  user?.accountEmployee?.email || user?.accountStudent?.email
                }
                disabled
                sx={{
                  "& .MuiInputBase-input.Mui-disabled": {
